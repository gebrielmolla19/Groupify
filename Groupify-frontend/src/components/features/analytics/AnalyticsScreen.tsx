          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-auto lg:h-[500px]">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between px-2">
                ...
                <span className="text-xs text-muted-foreground">Members orbit based on recency</span>
              </div>
              <Card className="flex-1 bg-black/40 border-white/5 overflow-hidden relative group">
                <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 pointer-events-none" />
                <CardContent className="h-full flex items-center justify-center p-6">
                  <SolarSystem members={memberData} isLoading={isLoading} />
                </CardContent>
              </Card>
            </div>
